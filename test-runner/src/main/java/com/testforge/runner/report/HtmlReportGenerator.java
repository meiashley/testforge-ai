...
public class HtmlReportGenerator {
    ...
    public String generate(ExecutionReport report) {
        ...
        sb.append("<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n")
          ...
          // AI Analysis styles
          .append(".ai-analysis-details { background: #f0f9ff; border: 1px solid #bae6fd;")
          .append(" border-radius: 8px; margin-top: 16px; box-shadow: none; }\n")
          .append(".ai-analysis-details[open] { padding-bottom: 12px; }\n")
          .append(".ai-analysis-summary { background: #e0f2fe; border-radius: 8px; font-size: 0.85rem;")
          .append(" font-weight: 600; color: #0369a1; padding: 10px 14px; gap: 10px; }\n")
          .append(".ai-analysis-summary:hover { background: #bae6fd; }\n")
          .append(".ai-analysis-body { padding: 12px 16px 0; display: flex; flex-direction: column; gap: 10px; }\n")
          .append(".ai-header { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }\n")
          .append(".category-badge { display: inline-block; padding: 3px 10px; border-radius: 9999px;")
          .append(" font-size: 0.72rem; font-weight: 700; text-transform: uppercase; color: #fff; }\n")
          .append(".category-TEST_LOGIC_ERROR { background: #dc2626; }\n")
          .append(".category-API_BUG { background: #9333ea; }\n")
          .append(".category-ASSERTION_TOO_STRICT { background: #ea580c; }\n")
          .append(".category-DATA_DEPENDENCY { background: #2563eb; }\n")
          .append(".category-ENVIRONMENT { background: #6b7280; }\n")
          .append(".category-UNCERTAIN { background: #ca8a04; }\n")
          .append(".confidence-badge { display: inline-block; padding: 3px 10px; border-radius: 9999px;")
          .append(" font-size: 0.72rem; font-weight: 700; text-transform: uppercase; color: #fff; }\n")
          .append(".confidence-HIGH { background: #16a34a; }\n")
          .append(".confidence-MEDIUM { background: #ca8a04; }\n")
          .append(".confidence-LOW { background: #6b7280; }\n")
          .append(".ai-field { font-size: 0.85rem; line-height: 1.5; color: #1e293b; }\n")
          .append(".ai-field strong { color: #0369a1; }\n")
    ...
    private void renderTestCase(StringBuilder sb, TestCaseResult r, FailureAnalysisResult analysis) {
        ...
        // AI Failure Analysis (failed cases only, when analysis is available)
    ...
    private void renderAiAnalysis(StringBuilder sb, FailureAnalysisResult a) {
        ...
        sb.append("<details class=\"ai-analysis-details\">\n")
          ...
          .append("<span class=\"category-badge category-").append(esc(category)).append("\">")
          .append(esc(categoryLabel)).append("</span>")
          .append("&nbsp;<span class=\"confidence-badge confidence-").append(esc(confidence)).append("\">")
          .append(esc(confidence)).append(" confidence</span>")
          .append("</summary>\n")
          .append("<div class=\"ai-analysis-body\">\n");

        if (a.getRootCauseSummary() != null) {
            sb.append("<div class=\"ai-field\"><strong>Root Cause:</strong> ")
              .append(esc(a.getRootCauseSummary())).append("</div>\n");
        }
        if (a.getEvidence() != null) {
            sb.append("<div class=\"ai-field\"><strong>Evidence:</strong> ")
              .append(esc(a.getEvidence())).append("</div>\n");
        }
        if (a.getSuggestedFix() != null) {
            sb.append("<div class=\"ai-field\"><strong>Suggested Fix:</strong> ")
              .append(esc(a.getSuggestedFix())).append("</div>\n");
        }
