...
public class GenerationService {
    ...
    public GenerationService(JobStore jobStore) {
    ...
    public String submitJob(String openApiUrl, String promptVersion) {
        ...
        CompletableFuture.runAsync(() -> executeJobAsync(jobId, openApiUrl, promptVersion));

        return jobId;
    }

    void executeJobAsync(String jobId, String openApiUrl, String promptVersion) {
